    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url("main/kaydet/"); ?>"><span
                                    class="menu-icon">
                        <i class="mdi mdi-account-plus"></i></span>Kaydet</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url("main/listele/"); ?>"><span
                                    class="menu-icon">
                        <i class="mdi mdi-table"></i></span>Listele</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url("main/myinformation/"); ?>"><span
                                    class="menu-icon">
