...
<head>
    ...
    <title>Dashboard-Bilgilerim</title>
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="<?= base_url() ?>main/myupdate/<?= $id ?>" method="post">
                                <div class="form-group">
                                    <label for="myName">İSİM</label>
                                    <input type="text" class="form-control" id="myName" name="myName"
                                           placeholder="İsim" value="<?php echo $this->session->userdata('adi'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="mySname">SOYİSİM</label>
                                    <input type="text" class="form-control" id="mySname" name="mySname"
                                           placeholder="Soyisim"
                                           value="<?php echo $this->session->userdata('soyadi'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="myDogumT">DOĞUM TARİHİ</label>
                                    <input type="date" class="form-control" id="myDogumT" name="myDogumT"
                                           value="<?php echo $this->session->userdata('dogum_tarihi'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="myPosta">E-POSTA</label>
                                    <input type="email" class="form-control" id="myPosta" name="myPosta"
                                           placeholder="E-Posta"
                                           value="<?php echo $this->session->userdata('eposta'); ?>">
                                    <?php echo form_error('myPosta'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="mySifre">ŞİFRE</label>
                                    <input type="password" class="form-control" id="mySifre" name="mySifre"
                                           placeholder="Şifre">
                                </div>
                                <div class="form-group">
                                    <label for="myCinsiyet">CİNSİYET</label>
                                    <select class="form-control" id="myCinsiyet" name="myCinsiyet">
                                ...
                                <div class="form-group">
                                    <label for="myKarakter">KARAKTER</label>
                                    <select class="form-control" id="myKarakter" name="myKarakter">
